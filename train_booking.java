...
public class train_booking {
    ...
    private static void admin() {
        System.out.println("\t\t\t\t-----------Welcome Konkan Admim-----------");
    ...
    private static void userList(){
        user_list.add(new users("Anitha", "1234", "9876543210",10000, 93));
        user_list.add(new users("Ragavi", "5678", "9123456780",9000, 92));
        user_list.add(new users("keerthana", "9012", "8901234567",3000, 90));
    }
